...
export default function NewEntry() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      alert("Error saving entry. Please log in again.");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    ...
    >
      ...
      <button
        ...
        disabled={loading}
        className="mt-6 w-full py-3 rounded-xl bg-cyan-500/30 hover:bg-cyan-400/50 text-white font-semibold tracking-wide shadow-[0_0_15px_#00ffffaa] transition-all disabled:opacity-50"
      >
